...
- 12 kategori × 300 soru = **3600 soru**, EN + TR tam çeviri
...
3600 sorumuz var; bu bir **içerik varlığı**, sadece oyun verisi değil.
...
| 6 | Sosyal içerik scripti (3.4) | Yüksek | 3 gün + sürekli | 3600 soru = içerik |
