...
const games = [
  ...
  {
    id: 'game_86',
    text: 'Which card game requires players to yell out the game\'s name when they have exactly one card left in their hand?',
    text_tr: 'Hangi kart oyununda oyuncuların elinde tam bir kart kaldığında oyunun adını bağırması gerekir?',
    options: { A: 'Poker', B: 'Bridge', C: 'Uno', D: 'Solitaire', E: 'Magic: The Gathering' },
    options_tr: { A: 'Poker', B: 'Briç', C: 'Uno', D: 'Solitaire', E: 'Magic: The Gathering' },
    answer: 'C',
    explanation: '"Uno" means "one" in Spanish and Italian, signaling that the player is close to winning.',
  },
  {
    id: 'game_87',
  ...
  {
    id: 'game_93',
    text: 'What is the name of the open-world cybernetic city in "Cyberpunk 2077"?',
    text_tr: '"Cyberpunk 2077" oyunundaki açık dünya sibernetik şehrin adı nedir?',
    options: { A: 'Neo-Tokyo', B: 'Night City', C: 'Mega-City One', D: 'Detroit 2038', E: 'Los Santos' },
    options_tr: { A: 'Neo-Tokyo', B: 'Night City', C: 'Mega-City One', D: 'Detroit 2038', E: 'Los Santos' },
    answer: 'B',
    explanation: 'Night City is a dystopian autonomous megacity located in California, controlled by corporations.',
  },
  {
    id: 'game_94',
  ...
  {
    id: 'game_100',
    text: 'What is the name of the rogue AI that serves as the main villain in "Portal 2"?',
    text_tr: '"Portal 2" oyununun ana kötüsü olan yapay zekanın adı nedir?',
